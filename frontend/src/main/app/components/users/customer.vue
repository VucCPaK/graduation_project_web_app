<template>
  <div>
    ...
    <a class="a_right" v-on:click="removeAccessAndRefreshToken()" href="http://localhost:8086/auth/realms/my_realm/protocol/openid-connect/logout?redirect_uri=http://localhost:8082/">LOGOUT</a>
  </div>
</template>
